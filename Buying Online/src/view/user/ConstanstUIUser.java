...
public class ConstanstUIUser {
	public static final Color BACKGROUND_COLOR_MAIN_WINDOW_USER = Color.decode("#FFC557");
	public static final ImageIcon IMAGE_CAR_BUY = new ImageIcon("src/img/carBuy.png");
	public static final ImageIcon IMAGE_FAIL_LOADING = new ImageIcon("src/img/loadingFail.png");
	...
	public static final Color COLOR_LINE_BORDER = Color.decode("#076AC0");
	public static final Font FONT_USER_WINDOW = new Font("Elephan", Font.ITALIC, 16);
}