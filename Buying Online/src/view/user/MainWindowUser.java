...
public class MainWindowUser extends JFrame {
	...
	public MainWindowUser(ControllerUser controllerUser) {
		...
		btnFavorites.setIcon(new ImageIcon(
				ConstanstUIUser.IMAGE_FAVORITES.getImage().getScaledInstance(40, -10, Image.SCALE_AREA_AVERAGING)));
		...
		btnListProducts.setIcon(new ImageIcon(ConstanstUIUser.IMAGE_ALL_TO_MENU_USER.getImage().getScaledInstance(40,
				-10, Image.SCALE_AREA_AVERAGING)));
		...
		btnShoppingCar.setIcon(new ImageIcon(
				ConstanstUIUser.IMAGE_CAR_BUY.getImage().getScaledInstance(40, -10, Image.SCALE_AREA_AVERAGING)));
		...
		btnSettings.setIcon(new ImageIcon(
				ConstanstUIUser.IMAGE_SETTINGS.getImage().getScaledInstance(40, -10, Image.SCALE_AREA_AVERAGING)));
